---
title: "Liquid Stack 主题更新与新增功能"
description: "按照功能模块介绍 Liquid Stack 的视觉、主页组件、内容展示、管理后台与双语体验。"
date: 2026-07-21
lastmod: 2026-08-02
...
头像旁的表情角标可以打开网站管理菜单，集中进入内容后台、评论管理、友链申请、GitHub Pages、搜索控制台、数据分析与部署平台。菜单项目通过数据文件配置，可以替换成自己的工具和地址。
